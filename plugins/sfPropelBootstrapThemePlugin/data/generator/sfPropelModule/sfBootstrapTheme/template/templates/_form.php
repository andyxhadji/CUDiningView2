...
[?php use_javascripts_for_form($form) ?]
  ...
  [?php echo form_tag_for($form, '@<?php echo $this->params['route_prefix'] ?>', array('class'=>'form-horizontal')) ?]
    ...
    [?php include_partial('<?php echo $this->getModuleName() ?>/form_actions_upper', array('<?php echo $this->getSingularName() ?>' => $<?php echo $this->getSingularName() ?>, 'form' => $form, 'configuration' => $configuration, 'helper' => $helper)) ?]
