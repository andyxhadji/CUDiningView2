...
<head>
  ...
  header("Content-type: text/plain"); //Set the content type to plain text so the print below is easy to read!
	...
	foreach($html->find('img') as $element) 
      	 echo $element->src . '<br>';
		print_r( "\n Done Printing HTML in img array function \n");
	
		$ret = $html->find('img');

		print_r("HTML Parse: ". $ret . "\n");
...
/*	$url = "http://www.dining.columbia.edu/menus";
	...
	curl_close($ch);
	$original_file  = json_decode($jsonData);*/
	...
	populate_img_array($original_file);
