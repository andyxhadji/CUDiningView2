 ...
 * @method UserQuery orderByVisits($order = Criteria::ASC) Order by the Visits column
 ...
 * @method UserQuery groupByVisits() Group by the Visits column
 ...
 * @method User findOneByVisits(int $Visits) Return the first User filtered by the Visits column
 ...
 * @method array findByVisits(int $Visits) Return User objects filtered by the Visits column
...
abstract class BaseUserQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `USER`, `NAME`, `GENDER`, `FOOD`, `VISITS`, `ID` FROM `user` WHERE `ID` = :p0';
        try {
    ...
    public function filterByVisits($visits = null, $comparison = null)
    {
        if (is_array($visits)) {
            $useMinMax = false;
            if (isset($visits['min'])) {
                $this->addUsingAlias(UserPeer::VISITS, $visits['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($visits['max'])) {
                $this->addUsingAlias(UserPeer::VISITS, $visits['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(UserPeer::VISITS, $visits, $comparison);
    }
