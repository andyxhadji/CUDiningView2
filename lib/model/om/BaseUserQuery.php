 ...
 *
 * @method UserQuery orderByUser($order = Criteria::ASC) Order by the User column
 ...
 *
 * @method UserQuery groupByUser() Group by the User column
 ...
 *
 * @method User findOneByUser(string $User) Return the first User filtered by the User column
 ...
 *
 * @method array findByUser(string $User) Return User objects filtered by the User column
...
abstract class BaseUserQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `USER`, `NAME`, `GENDER`, `FOOD`, `ID`, `VISITS` FROM `user` WHERE `ID` = :p0';
        try {
    ...
    public function filterByUser($user = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(UserPeer::USER, $user, $comparison);
    }
