...
abstract class BaseUser extends BaseObject implements Persistent
{
    ...
    public function setFood($v)
    {
        ...
        if ($this->food !== $v) {
            $this->food = $v;
            $this->modifiedColumns[] = UserPeer::FOOD;
        }
    ...
    public function setVisits($v)
    {
        ...
        if ($this->visits !== $v) {
            $this->visits = $v;
            $this->modifiedColumns[] = UserPeer::VISITS;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->user = ($row[$startcol + 0] !== null) ? (string) $row[$startcol + 0] : null;
            $this->name = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->gender = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->food = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
            $this->id = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
            $this->visits = ($row[$startcol + 5] !== null) ? (int) $row[$startcol + 5] : null;
            $this->resetModified();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(UserPeer::USER)) {
        ...
        if ($this->isColumnModified(UserPeer::FOOD)) {
            $modifiedColumns[':p' . $index++]  = '`FOOD`';
        }
        if ($this->isColumnModified(UserPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`ID`';
        }
        if ($this->isColumnModified(UserPeer::VISITS)) {
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setUser($arr[$keys[0]]);
        ...
        if (array_key_exists($keys[5], $arr)) $this->setVisits($arr[$keys[5]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UserPeer::FOOD)) $criteria->add(UserPeer::FOOD, $this->food);
        if ($this->isColumnModified(UserPeer::ID)) $criteria->add(UserPeer::ID, $this->id);
        if ($this->isColumnModified(UserPeer::VISITS)) $criteria->add(UserPeer::VISITS, $this->visits);
