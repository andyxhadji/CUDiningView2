...
abstract class BaseUserPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('User', 'Name', 'Gender', 'Food', 'Id', 'Visits', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('user', 'name', 'gender', 'food', 'id', 'visits', ),
        BasePeer::TYPE_COLNAME => array (UserPeer::USER, UserPeer::NAME, UserPeer::GENDER, UserPeer::FOOD, UserPeer::ID, UserPeer::VISITS, ),
        BasePeer::TYPE_RAW_COLNAME => array ('USER', 'NAME', 'GENDER', 'FOOD', 'ID', 'VISITS', ),
        BasePeer::TYPE_FIELDNAME => array ('User', 'Name', 'Gender', 'Food', 'id', 'Visits', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('User' => 0, 'Name' => 1, 'Gender' => 2, 'Food' => 3, 'Id' => 4, 'Visits' => 5, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('user' => 0, 'name' => 1, 'gender' => 2, 'food' => 3, 'id' => 4, 'visits' => 5, ),
        BasePeer::TYPE_COLNAME => array (UserPeer::USER => 0, UserPeer::NAME => 1, UserPeer::GENDER => 2, UserPeer::FOOD => 3, UserPeer::ID => 4, UserPeer::VISITS => 5, ),
        BasePeer::TYPE_RAW_COLNAME => array ('USER' => 0, 'NAME' => 1, 'GENDER' => 2, 'FOOD' => 3, 'ID' => 4, 'VISITS' => 5, ),
        BasePeer::TYPE_FIELDNAME => array ('User' => 0, 'Name' => 1, 'Gender' => 2, 'Food' => 3, 'id' => 4, 'Visits' => 5, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
    );
