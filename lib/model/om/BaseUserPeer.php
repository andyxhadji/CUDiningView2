...
abstract class BaseUserPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('UserId', 'Name', 'Gender', 'Food', 'Id', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('userId', 'name', 'gender', 'food', 'id', ),
        BasePeer::TYPE_COLNAME => array (UserPeer::USER, UserPeer::NAME, UserPeer::GENDER, UserPeer::FOOD, UserPeer::ID, ),
        BasePeer::TYPE_RAW_COLNAME => array ('USER', 'NAME', 'GENDER', 'FOOD', 'ID', ),
        BasePeer::TYPE_FIELDNAME => array ('User', 'Name', 'Gender', 'Food', 'id', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('UserId' => 0, 'Name' => 1, 'Gender' => 2, 'Food' => 3, 'Id' => 4, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('userId' => 0, 'name' => 1, 'gender' => 2, 'food' => 3, 'id' => 4, ),
        BasePeer::TYPE_COLNAME => array (UserPeer::USER => 0, UserPeer::NAME => 1, UserPeer::GENDER => 2, UserPeer::FOOD => 3, UserPeer::ID => 4, ),
        BasePeer::TYPE_RAW_COLNAME => array ('USER' => 0, 'NAME' => 1, 'GENDER' => 2, 'FOOD' => 3, 'ID' => 4, ),
        BasePeer::TYPE_FIELDNAME => array ('User' => 0, 'Name' => 1, 'Gender' => 2, 'Food' => 3, 'id' => 4, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
    );
